...
impl Render for ProjectPanel {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if has_worktree {
            ...
            let workspace_for_fossil_clone = self.workspace.clone();
            ...
            v_flex()
                ...
                .child(
                    ...
                    .on_clone_fossil_repo(move |_, window, cx| {
                        telemetry::event!("Project Panel Clone Fossil Repo Clicked");
                        workspace_for_fossil_clone
                            .update(cx, |_, cx| {
                                window
                                    .dispatch_action(git::fossil_actions::Clone.boxed_clone(), cx);
                            })
                            .log_err();
                    }),
                )
