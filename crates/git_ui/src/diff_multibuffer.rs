...
impl DiffMultibuffer {
    pub(crate) fn new(
        ...
        configure_editor: impl FnOnce(
            &mut SplittableEditor,
            Rc<RefCell<HashMap<BufferId, RepoPath>>>,
            &mut Context<SplittableEditor>,
        ) + 'static,
        ...
        let editor_buffer_rename_sources = buffer_rename_sources.clone();
        let editor = cx.new(|cx| {
            ...
            configure_editor(&mut diff_display_editor, editor_buffer_rename_sources, cx);
