...
pub struct ProjectEmptyState {
    ...
    on_clone_fossil_repo: Option<ClickHandler>,
}
...
impl ProjectEmptyState {
    ...
    pub fn on_clone_fossil_repo(
        mut self,
        handler: impl Fn(&ClickEvent, &mut Window, &mut App) + 'static,
    ) -> Self {
        self.on_clone_fossil_repo = Some(Box::new(handler));
        self
    }
}
        ...
        v_flex()
            ...
            .child(
                v_flex()
                    ...
                    .when_some(self.on_clone_fossil_repo, |this, handler| {
                        this.child(
